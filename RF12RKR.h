...
extern uint8_t rf12_len;     // number of data bytes in rf12_buf
...
extern volatile uint16_t rf12_status;  // running crc value, should be zero at end
...
#define RXFILL_MIN (3)
#define SYNC2
unsigned int freq = 0xA680;
#ifdef SYNC2
#define RXFILL_SYNC 2
#else
unsigned int freq = 0xA680; // 868.0
#define RXFILL_SYNC 1
#endif
#else
#define RXFILL_MIN (4)
#endif
